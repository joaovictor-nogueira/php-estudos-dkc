...
<body>
    ...
    <section class="descricao-autor">
        ...
        <div class="w50">
            ...
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ut id, dolore deleniti ab aliquam nostrum laborum vero officiis cupiditate minus, doloribus alias tenetur. Odio fugiat quidem sint architecto eaque aspernatur!</p>
            
        </div> <!-- W50 -->  
        <div class="w50">
            <!-- PEGAR IMG DPS -->
            <img src="imagens/foto1.jpeg" alt="imagem">
        </div> <!-- W50 -->
        </div> <!-- center -->
